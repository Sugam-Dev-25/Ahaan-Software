...
var OutlinedInput = React43.forwardRef(function OutlinedInput2(inProps, ref) {
  ...
  const [NotchedSlot, notchedProps] = useSlot("notchedOutline", {
    ...
    additionalProps: {
      label: label != null && label !== "" && fcs.required ? (0, import_jsx_runtime24.jsxs)(React43.Fragment, {
        children: [label, " ", "*"]
      }) : label
    }
  });
...
function getReactElementRef(element) {
  var _a;
  if (parseInt(React48.version, 10) >= 19) {
...
function useLazyRef(init, initArg) {
  const ref = React52.useRef(UNINITIALIZED);
...
var Portal = React56.forwardRef(function Portal2(props, forwardedRef) {
  ...
  const handleRef = useForkRef(React56.isValidElement(children) ? getReactElementRef(children) : null, forwardedRef);
  useEnhancedEffect_default(() => {
    if (!disablePortal) {
...
var NativeSelectInput = React64.forwardRef(function NativeSelectInput2(props, ref) {
  ...
  return (0, import_jsx_runtime39.jsxs)(React64.Fragment, {
...
var Select = React67.forwardRef(function Select2(inProps, ref) {
  ...
  return (0, import_jsx_runtime42.jsx)(React67.Fragment, {
